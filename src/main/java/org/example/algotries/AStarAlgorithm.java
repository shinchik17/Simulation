...
public class AStarAlgorithm {
    ...
    public static ArrayList<Node> aStar(Node startNode, Node endNode, boolean[][] obstacles){
        ...
        while (!openNodesQueue.isEmpty()) {
            ...
            ArrayList<Node> neighbours = findNeighbours(obstacles, currentNode); // ищем валидных соседей
    ...
    private static ArrayList<Node> findNeighbours(boolean[][] obstacles, Node currentNode) {
